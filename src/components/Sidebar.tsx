...
import { CreditCard, LayoutDashboard, MapPin, Settings, Users, X } from 'lucide-react'
...
export default function Sidebar(props: SidebarProps) {
  ...
  const items: Array<{ label: string; icon: LucideIcon; href: string }> = [
    ...
    { label: 'Parc', icon: MapPin, href: '/parc' },
    { label: 'Paiements', icon: CreditCard, href: '/paiements' },
    { label: 'Investisseurs', icon: Users, href: '/investisseurs' },
    ...
    <>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="leading-tight">
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">Portail Admin</div>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="truncate text-sm font-semibold text-slate-900 dark:text-slate-50">Grand Patron</div>
                    <div className="truncate text-xs text-slate-500 dark:text-slate-400">Super Admin</div>
                  </div>
                </div>
                <button
                  type="button"
      ...
      <aside className="hidden shrink-0 lg:flex lg:w-72 lg:flex-col lg:sticky lg:top-0 lg:h-screen lg:overflow-y-auto lg:border-r lg:border-slate-200 lg:bg-white lg:p-5 dark:border-slate-800 dark:bg-slate-900">
        <div className="flex items-center justify-between gap-3">
          <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-blue-600 text-white shadow-sm">
            <img src="/CamerRideShare_Logo.png" alt="CamerRideShare" className="h-8 w-8 rounded-lg object-contain" />
          </div>
          <div className="leading-tight">
            <div className="text-sm font-semibold text-slate-900 dark:text-slate-50">CamerRideShare</div>
            <div className="text-xs text-slate-500 dark:text-slate-400">Portail Admin</div>
