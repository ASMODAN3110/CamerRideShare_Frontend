...
// ─── EffectCard ───────────────────────────────────────────────────────────
// Wraps any element with hover effects: particles, tilt, magnetism, click ripple, border glow.
...
export function EffectCard({
  ...
  const borderGlowClass = enableBorderGlow ? 'effect-border-glow' : ''
...
// ─── GlobalSpotlight ─────────────────────────────────────────────────────
// Fixed cursor spotlight that illuminates cards inside a section.
...
export function GlobalSpotlight({
  ...
  glowColor = DEFAULT_GLOW_COLOR,
  cardSelector = '.effect-border-glow, .magic-bento-card',
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = () => {
      ...
      gridRef.current?.querySelectorAll<HTMLElement>(cardSelector).forEach((card) =>
...
// ─── SpotlightSection ─────────────────────────────────────────────────────
// Wraps content with a spotlight effect and a section ref.
...
export function SpotlightSection({
  ...
  return (
    <>
      {enableSpotlight && (
        <GlobalSpotlight
          gridRef={sectionRef as React.RefObject<HTMLDivElement | null>}
...
// ─── Original card data (kept for MagicBento grid) ────────────────────────
