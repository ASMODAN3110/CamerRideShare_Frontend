...
import { BarChart3, LayoutDashboard, MapPin, Settings, Users, X } from 'lucide-react'
...
export default function InvestorSidebar(props: InvestorSidebarProps) {
  ...
  const items = useMemo(() => {
    return [
      { label: 'Tableau de bord', icon: LayoutDashboard, href: '/investor-dashboard' },
      { label: 'Mon Parc', icon: MapPin, href: '/investor-fleet' },
      { label: 'Historique des Revenus', icon: Users, href: '/investor-revenues' },
      { label: 'Rapports', icon: BarChart3, href: '/investor-reports' },
      { label: 'Paramètres', icon: Settings, href: '/investor-settings' },
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div className="leading-tight">
                  ...
                  <div className="text-xs text-slate-500 dark:text-slate-400">Espace Investisseur</div>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-slate-200 bg-slate-50 p-3 dark:border-slate-800 dark:bg-slate-950">
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    <div className="truncate text-sm font-semibold text-slate-900 dark:text-slate-50">Patron Invest</div>
                    <div className="truncate text-xs text-slate-500 dark:text-slate-400">Investisseur</div>
                  </div>
                </div>
                <Button
                  type="button"
